...
import com.gin.multimedia.audio.adapter.AmrListAdapter
 ...
 * @see
 */
class AmrPlayerActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (fDir.exists()) {
            ...
            rv_list.adapter = AmrListAdapter(this, fDir.listFiles().toList().filter { it.name.endsWith("amr") })
        }
    }
}