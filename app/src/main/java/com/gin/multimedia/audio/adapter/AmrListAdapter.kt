...
import com.gin.multimedia.audio.AmrPlayer
 ...
 * @see
 */
class AmrListAdapter(context: Context, audioList: List<File>): BaseAdapter<File>(context, audioList) {

    private val audioPlayer: AudioPlayer = AmrPlayer()
